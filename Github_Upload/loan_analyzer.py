...
print(f"There are a total of {total_loans} loans")
...
if present_value >= loan_price:
    ...
    print(f"The loan is too expensive and is not worth the price.")
